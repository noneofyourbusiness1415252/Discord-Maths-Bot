use pyo3::prelude::*;
#[pymodule]
fn maths_stuff(_: Python, m: &PyModule) -> PyResult<()> {
	#[pyfn(m)]
	#[pyo3(name = "nthpowers")]
	fn nthpowers(_p: Python, start: u64, end: u64) -> PyResult<String> {
	...
	#[pyfn(m)]
	#[pyo3(name = "primesupto")]
	fn primesupto(_p: Python, n: usize) -> PyResult<Vec<usize>> {
